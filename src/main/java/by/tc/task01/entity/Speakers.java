...
public class Speakers implements Appliance, Serializable {
	...
	private static final long serialVersionUID = -7433298175680450163L;
	...
	public void setFrequencyRange(String i) {
		this.frequencyRange = i;
	}
	...
	public String toString() {
		return getClass().getSimpleName() + " :powerConsumption=" + powerConsumption + ", numberOfSpeakers="
