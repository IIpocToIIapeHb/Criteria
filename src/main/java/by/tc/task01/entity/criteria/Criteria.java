...
public class Criteria {
    ...
    public void remove(String removeParameter){
        criteria.remove(removeParameter);
    }

    public int numberOfParametersInCriteria(){
    ...
    public String toString() {
        return getClass().getSimpleName() +
                " : groupSearchName='" + groupSearchName + ", parameters=" + criteria;
    }
}
